(function(){
    ...
    class Slider{
        constructor(element, feather_color, title_color, detail_color){
            ...
            wrapper.style.cssText = 'width: 100%; height: 100%; position: relative; max-width: 100%;'

            //create images wrapper 
            let images_wrapper = document.createElement('div')
            wrapper.appendChild(images_wrapper)
            images_wrapper.style.cssText = 'width: 100%; height: 100%; position: relative; display: flex'
            ...
            imageIn.style.cssText = 'width: 100%; position: relative;'

            let imageOut = document.createElement('img')

            images_wrapper.appendChild(imageOut)
            imageOut.style.cssText = 'width: 100%; position: relative'
            ...
            dot_div.style.cssText = `position: absolute; top: 70%; left: 50%; transform: translateX(-50%) translateY(70%);`
